...
| 項目 | 數量 | 來源 |
|---|---:|---|
| Runtime MCP tools | 183 | `MCP-Server/src/tools/index.ts` 的 `registerRevitTools()` |
| Domain SOP files | 81 | `domain/*.md` 扣除 `README.md`，加上 `domain/references/*.md` |
...
| Human-facing | `README.md`, `README.zh-TW.md`, `docs/`, `scripts/README.md` | 依讀者語言撰寫 |
